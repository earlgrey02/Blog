...
이에 대해서는 저와 인프라 팀원 분이 IaC(Infrastructure as Code)에 대한 신념이 있었고, 이미 인프라 팀원 분이 Terraform을 통해 인프라를 구성하고 계셨습니다.
저는 IaC는 언제든지 인프라를 복구할 수 있으며 기술 공유가 쉽다는 점에서 좋게 평가하고 있었습니다.
